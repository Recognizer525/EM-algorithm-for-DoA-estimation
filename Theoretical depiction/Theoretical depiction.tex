...
Параметры апостериорного распределения $\Prob(X_{t, m_t} \mid \Info_t), t=1,\ldots,T$ на итерации $\tau$ можно найти следующим образом:
\begin{equation*}
\left\{ \begin{aligned} 
